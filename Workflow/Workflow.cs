...
public class Workflow
{
  ...
  public Workflow()
  {
    _activities = new List<IActivity>
    {
      ...
      { new IndoorActivity{Message = "Bowling..."} },
      { new IndoorActivity{Message = "Boxing..."} },
      { new IndoorActivity{Message = "Swimming..."} },
      { new IndoorActivity{Message = "Jumping..."} },
      { new IndoorActivity{Message = "Coloring..."} },
    };
  }
